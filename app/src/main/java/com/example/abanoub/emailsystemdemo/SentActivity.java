    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (title) {
                    ...
                    case "Sent":
                        ...
                        break;
                    case "Favorites":
                        startActivity(new Intent(SentActivity.this, FavoritesActivity.class));

                        break;
                    case "Trash":
                        startActivity(new Intent(SentActivity.this, TrashActivity.class));
                        break;
                    case "Sign out":
                        FirebaseAuth.getInstance().signOut();
                        startActivity(new Intent(SentActivity.this, SignInActivity.class));
                        break;
                    case "Profile":
                        startActivity(new Intent(SentActivity.this, ProfileActivity.class));
                        break;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (email==null)
                    return;
                Intent intent = new Intent(SentActivity.this, DetailedActivity.class);
        ...
        composeEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SentActivity.this, ComposeEmailActivity.class));
            }
        });
    }
